...
object RepositoryModule {
    ...
    @Provides
    fun teamRepositoryProvider(teamRemoteDataSource : TeamRemoteDataSource,teamLocalDataSource: TeamLocalDataSource): TeamRepository =
        TeamRepository(teamRemoteDataSource, teamLocalDataSource)

    @Provides
    fun playerRepositoryProvider(playerRemoteDataSource: PlayerRemoteDataSource, playerLocalDataSource: PlayerLocalDataSource): PlayerRepository =
        PlayerRepository(playerRemoteDataSource, playerLocalDataSource)

    @Provides
    fun positionRepositoryProvider(positionRemoteDataSource: PositionRemoteDataSource, positonLocalDataSource: PositionLocalDataSource): PositionRepository =
