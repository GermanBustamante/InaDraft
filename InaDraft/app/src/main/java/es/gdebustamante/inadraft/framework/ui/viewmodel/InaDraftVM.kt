...
import es.gdebustamante.inadraft.usecases.LoadTeamListUseCase
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import javax.inject.Inject

@HiltViewModel
class InaDraftVM @Inject constructor(private val loadTeamListUseCase: LoadTeamListUseCase) : ViewModel() {
