package es.gdebustamante.inadraft.framework
...
import es.gdebustamante.inadraft.framework.data.datasources.ServerTeamDataSource
...
class FrameworkModule {
    ...
    fun serverDataSourceProvider(teamApiService: TeamAPIService): ServerDataSource {
        return ServerTeamDataSource(teamApiService)
    }
